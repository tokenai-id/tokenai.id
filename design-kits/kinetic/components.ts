...
/**
 * Fragmen `components/` kit Kinetic: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set carbon — garis geometris tipis IBM yang senada dengan lembar
 * type specimen). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat
 * merakit halaman, jadi jangan menaruh style atribut di sini.
 *
...
export const KINETIC_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-select-menu">
        <button class="tk-option tk-option-selected" type="button">Opsi pertama <span class="tk-option-check">${icon('checkmark', 15)}</span></button>
        <button class="tk-option" type="button">Opsi kedua</button>
...
<div class="tk-select">
    ...
    <div class="tk-select-menu">
        ...
        <button class="tk-option tk-option-selected" type="button">John Doe <span class="tk-option-check">${icon('checkmark', 15)}</span></button>
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('edit', 15)} Edit</button>
        <button class="tk-dropdown-item">${icon('copy', 15)} Duplikat</button>
        <hr class="tk-dropdown-divider">
        <button class="tk-dropdown-item tk-dropdown-item-danger">${icon('trash-can', 15)} Hapus</button>
    </div>
</div>
`,
    ...
    <div class="tk-select">
        ...
        <div class="tk-select-menu">
            <button class="tk-option tk-option-selected" type="button">Semua status <span class="tk-option-check">${icon('checkmark', 15)}</span></button>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item" href="#">${icon('chart-bar', 17)} <span class="tk-sidebar-label">Laporan</span></a>
    <span class="tk-sidebar-group">Lainnya</span>
    <a class="tk-sidebar-item" href="#">${icon('settings', 17)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('edit', 15)}</button>
                <button class="tk-action-btn tk-action-btn-danger" aria-label="Hapus">${icon('trash-can', 15)}</button>
            </td>
        </tr>
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('overflow-menu-horizontal', 15)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('text-font', 26)}</span>
...
`,
    ...
    <p class="tk-kicker">Spesimen 01 &mdash; Hero</p>
    <h1 class="tk-display">Bangun <span class="tk-outline-text-primary tk-outline-text">lebih</span> cepat</h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('lightning', 24)}</span>
