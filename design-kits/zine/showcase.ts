...
/**
 * `showcase.html` kit Zine: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const ZINE_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Zine — Design Kit Showcase</title>
...
<body>
${exNav('Zine', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Zine</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Kertas dan tinta, merah riot, sudut tajam, bayangan offset keras &mdash; tersedia mode terang (kertas) dan gelap (tinta). Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Archivo Black (heading, uppercase) &middot; Space Grotesk (body) &middot; Space Mono (caption &amp; tombol) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Kertas &amp; tinta</span><span class="tk-badge">Merah riot</span><span class="tk-badge">Sudut tajam</span><span class="tk-badge">Fotokopian</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Kertas pucat dengan garis tinta tebal, tanpa radius, dan kedalaman dari bayangan offset keras &mdash; seperti potongan zine yang difotokopi. Satu merah riot dipakai hemat untuk sorotan; sisanya kerja keras tipografi: judul Archivo Black uppercase, caption dan tombol bermono.</p>`)}
