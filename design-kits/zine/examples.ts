...
/**
 * Halaman contoh (`examples/`) kit Zine: admin dashboard dan landing page utuh yang
...
<title>Zine — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Zine', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Zine', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Zine', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<body>
${exNav('Zine', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const ZINE_EXAMPLES: Record<string, string> = {
