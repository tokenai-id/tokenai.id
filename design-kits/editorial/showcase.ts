...
/**
 * `showcase.html` kit Editorial: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const EDITORIAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Editorial — Design Kit Showcase</title>
...
<body>
${exNav('Editorial', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Editorial</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Tampilan majalah premium &mdash; headline serif besar, garis rambut (hairline rules), whitespace luas, grid kuat, dan satu aksen oxblood yang dipakai hemat; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Playfair Display (heading, serif) &middot; Libre Franklin (body) &middot; Spline Sans Mono (caption &amp; kode) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Majalah premium</span><span class="tk-badge">Serif besar</span><span class="tk-badge">Hairline rules</span><span class="tk-badge">Whitespace luas</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Halaman yang terasa seperti spread majalah cetak: headline serif Playfair Display raksasa, garis rambut tipis sebagai pemisah, whitespace yang tidak takut kosong, dan label uppercase berjarak renggang seperti masthead. Warna nyaris hanya tinta di atas kertas &mdash; satu oxblood merah anggur dipakai hemat untuk penekanan.</p>`)}
