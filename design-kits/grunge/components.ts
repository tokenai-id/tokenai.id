...
/**
 * Fragmen `components/` kit Grunge: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set feather — garis tangan tipis yang netral, membiarkan tekstur
 * dan tipografi yang bicara). Gayanya seluruhnya di `styles.css` — fragmen inilah yang
...
export const GRUNGE_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('edit-2', 16)} Edit</button>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('grid', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('bar-chart-2', 18)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('edit-2', 16)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('archive', 28)}</span>
...
`,
    ...
    <h1 class="tk-display tk-xerox">Bangun <span class="tk-marker">lebih cepat</span></h1>
