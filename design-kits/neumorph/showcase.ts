...
/**
 * `showcase.html` kit Neumorph: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const NEUMORPH_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Neumorph — Design Kit Showcase</title>
...
<body>
${exNav('Neumorph', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Neumorph</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Elemen seolah menyatu dengan latar &mdash; timbul dan tenggelam lewat highlight serta soft shadow ganda, lembut seperti objek fisik; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Poppins (heading) &middot; Nunito Sans (body) &middot; IBM Plex Mono (kode) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Soft UI</span><span class="tk-badge">Embossed</span><span class="tk-badge">Highlight &amp; shadow</span><span class="tk-badge">Menyatu dengan latar</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Permukaan dan latar berbagi warna yang sama; kedalaman lahir dari sepasang bayangan &mdash; cahaya dari kiri-atas, bayang jatuh ke kanan-bawah &mdash; sehingga panel terasa timbul dari latar dan input tenggelam ke dalamnya, seperti tombol fisik yang bisa diraba. Tanpa garis tepi, sudut membulat besar, satu aksen biru-ungu dipakai hemat.</p>`)}
