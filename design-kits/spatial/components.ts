...
/**
 * Fragmen `components/` kit Spatial: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set akar-icons — garis geometris presisi yang senada dengan ruang
 * 3D). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat merakit
...
export const SPATIAL_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('eye-open', 15)} Lihat detail</button>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item" href="#">${icon('statistic-up', 17)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                <button class="tk-action-btn" aria-label="Lihat">${icon('eye-open', 15)}</button>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('thunder', 24)}</span>
