...
/**
 * Fragmen `components/` kit Punk: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set la / Line Awesome — garis tebal ala Font Awesome yang cocok
 * dengan poster DIY). Gayanya seluruhnya di `styles.css` — fragmen inilah yang
...
export const PUNK_COMPONENTS: Record<string, string> = {
...
<div class="tk-field">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih satu opsi</span> ${icon('angle-down', 16)}</button>
...
`,
    ...
    <button class="tk-select-trigger" type="button">Opsi pertama ${icon('angle-down', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih anggota</span> ${icon('angle-down', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button">Peran &middot; 2 dipilih ${icon('angle-down', 16)}</button>
    <div class="tk-select-menu">
...
`,
    ...
    <button class="tk-btn tk-btn-outline">Aksi ${icon('angle-down', 16)}</button>
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item tk-dropdown-item-danger">${icon('trash-alt', 16)} Hapus</button>
    </div>
</div>
`,
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua status ${icon('angle-down', 16)}</button>
        <div class="tk-select-menu">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua peran ${icon('angle-down', 16)}</button>
        <div class="tk-select-menu">
            <label class="tk-option"><input class="tk-checkbox" type="checkbox" checked> Designer</label>
...
<nav class="tk-breadcrumb">
    <a href="#">Beranda</a>
    <span class="tk-breadcrumb-sep">${icon('angle-right', 14)}</span>
    <a href="#">Proyek</a>
    <span class="tk-breadcrumb-sep">${icon('angle-right', 14)}</span>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('th-large', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn tk-action-btn-danger" aria-label="Hapus">${icon('trash-alt', 16)}</button>
            </td>
        </tr>
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('ellipsis-h', 16)}</button>
...
`,
    ...
    <h1 class="tk-display tk-ransom"><span>Bangun</span> <span>lebih</span> <span>cepat</span></h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('bolt')}</span>
