...
/**
 * `showcase.html` kit Brutal: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const BRUTAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Brutal — Design Kit Showcase</title>
...
<body>
${exNav('Brutal', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Brutal</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Mentah dan keras &mdash; tipografi raksasa, kontras hitam-putih tajam, border tebal, aksen elektrik, tanpa polesan; tersedia mode terang dan gelap (negatif). Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Anton (heading, uppercase) &middot; Inter Tight (body) &middot; Courier Prime (caption &amp; tombol) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Mentah</span><span class="tk-badge">Kontras keras</span><span class="tk-badge">Border tebal</span><span class="tk-badge">Tanpa polesan</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Putih dan hitam berhadapan tanpa kompromi: border 3px di mana-mana, tanpa radius, tanpa bayangan halus &mdash; kedalaman cukup dari garis dan blok warna. Tipografi Anton raksasa serba kapital memimpin halaman, biru elektrik dan stabilo kuning dipakai sebagai pukulan aksen; sisanya sengaja dibiarkan terlihat seperti dokumen mentah.</p>`)}
