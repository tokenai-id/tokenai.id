...
/**
 * Fragmen `components/` kit Organic: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set mingcute — garis rounded lembut yang senada dengan bentuk
 * organik). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat
...
export const ORGANIC_COMPONENTS: Record<string, string> = {
...
<div class="tk-field">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih satu opsi</span> ${icon('down-line', 16)}</button>
...
`,
    ...
    <button class="tk-select-trigger" type="button">Opsi pertama ${icon('down-line', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih anggota</span> ${icon('down-line', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button">Peran &middot; 2 dipilih ${icon('down-line', 16)}</button>
    <div class="tk-select-menu">
...
`,
    ...
    <button class="tk-btn tk-btn-outline">Aksi ${icon('down-line', 16)}</button>
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('edit-2-line', 16)} Edit</button>
        <button class="tk-dropdown-item">${icon('copy-2-line', 16)} Duplikat</button>
        <hr class="tk-dropdown-divider">
        <button class="tk-dropdown-item tk-dropdown-item-danger">${icon('delete-2-line', 16)} Hapus</button>
    </div>
</div>
`,
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua status ${icon('down-line', 16)}</button>
        <div class="tk-select-menu">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua peran ${icon('down-line', 16)}</button>
        <div class="tk-select-menu">
            <label class="tk-option"><input class="tk-checkbox" type="checkbox" checked> Designer</label>
            <label class="tk-option"><input class="tk-checkbox" type="checkbox"> Developer</label>
        </div>
    </div>
    <button class="tk-btn tk-btn-outline">${icon('filter-line', 16)} Filter <span class="tk-filter-count">2</span></button>
</div>
...
<nav class="tk-breadcrumb">
    <a href="#">Beranda</a>
    <span class="tk-breadcrumb-sep">${icon('right-line', 14)}</span>
    <a href="#">Proyek</a>
    <span class="tk-breadcrumb-sep">${icon('right-line', 14)}</span>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('grid-line', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('chart-bar-line', 18)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('edit-2-line', 16)}</button>
                <button class="tk-action-btn tk-action-btn-danger" aria-label="Hapus">${icon('delete-2-line', 16)}</button>
            </td>
        </tr>
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('more-1-line', 16)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('inbox-line', 28)}</span>
...
`,
    ...
    <h1 class="tk-display">Bangun lebih <span class="tk-underline-wave">cepat</span></h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('lightning-line', 26)}</span>
