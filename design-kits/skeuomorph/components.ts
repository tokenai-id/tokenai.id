...
/**
 * Fragmen `components/` kit Skeuomorph: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set bi / Bootstrap Icons — garis presisi netral yang cocok untuk label
 * panel hardware). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat
...
export const SKEUOMORPH_COMPONENTS: Record<string, string> = {
...
<button class="tk-btn tk-btn-outline tk-btn-icon" aria-label="Tambah">${icon('plus-lg')}</button>
`,
...
`,
    ...
    <div class="tk-select-menu">
        <button class="tk-option tk-option-selected" type="button">Opsi pertama <span class="tk-option-check">${icon('check-lg', 15)}</span></button>
        <button class="tk-option" type="button">Opsi kedua</button>
...
<div class="tk-select">
    ...
    <div class="tk-select-menu">
        ...
        <button class="tk-option tk-option-selected" type="button">John Doe <span class="tk-option-check">${icon('check-lg', 15)}</span></button>
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('pencil-square', 15)} Edit</button>
...
`,
    ...
    <div class="tk-select">
        ...
        <div class="tk-select-menu">
            <button class="tk-option tk-option-selected" type="button">Semua status <span class="tk-option-check">${icon('check-lg', 15)}</span></button>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('speedometer2', 17)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('gear', 17)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('pencil-square', 15)}</button>
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('three-dots', 15)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('inbox', 26)}</span>
