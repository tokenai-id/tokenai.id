...
/**
 * Fragmen `components/` kit Aurora: markup murni dengan kelas kontrak, teks placeholder netral,
 * ikon Iconify (set heroicons gaya bawaannya — garis 24px berujung membulat dengan sapuan lapang,
 * senada dengan permukaan kit yang serba lembut).
...
export const AURORA_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <span class="tk-search-icon">${icon('magnifying-glass', 15)}</span>
...
<div class="tk-select">
    ...
    <div class="tk-select-menu">
        <div class="tk-select-menu-search">${icon('magnifying-glass', 13)}<input type="text" placeholder="Cari anggota..."></div>
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('document-duplicate', 15)} Duplikat</button>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('squares-2x2', 17)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('arrow-trending-up', 17)} <span class="tk-sidebar-label">Laporan</span></a>
    <span class="tk-sidebar-group">Lainnya</span>
    <a class="tk-sidebar-item" href="#">${icon('cog-6-tooth', 17)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('bolt', 24)}</span>
