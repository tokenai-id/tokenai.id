...
/**
 * Fragmen `components/` kit Soft UI: markup murni dengan kelas kontrak, teks placeholder netral,
 * ikon Iconify (set mage — garis membulat berujung tumpul, senada dengan radius besar kitnya).
 * Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat merakit halaman,
 * jadi jangan menaruh atribut style di sini.
 *
...
export const SOFT_UI_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('edit', 16)} Edit</button>
...
<div class="tk-filter-active">
    <span class="tk-body-sm tk-muted">Filter aktif</span>
...
<div class="tk-card tk-card-stat">
    <div class="tk-card-body">
        <p class="tk-body-sm tk-muted">Total Pengguna</p>
        <p class="tk-stat-value">12.540</p>
        <span class="tk-stat-trend-up">12,5%</span>
    </div>
</div>
`,
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item" href="#">${icon('chart', 18)} <span class="tk-sidebar-label">Laporan</span></a>
...
<div class="tk-alert tk-alert-warning">${icon('exclamation-circle', 18)}<span><span class="tk-alert-title">Perhatian.</span> Periksa kembali informasi Anda.</span></div>
<div class="tk-alert tk-alert-danger">${icon('exclamation-triangle', 18)}<span><span class="tk-alert-title">Gagal.</span> Terjadi kesalahan, coba lagi.</span></div>
<div class="tk-alert tk-alert-info">${icon('information-circle', 18)}<span><span class="tk-alert-title">Info.</span> Ada pembaruan penting untuk Anda.</span></div>
`,
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('edit', 16)}</button>
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('dots-horizontal', 16)}</button>
...
`,
    ...
    <span class="tk-badge tk-badge-success">Baru</span>
    <h1 class="tk-display">Bangun lebih tenang</h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('stars-a', 24)}</span>
