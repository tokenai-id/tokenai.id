...
/**
 * Fragmen `components/` kit Hyperreality: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set fluent gaya `-24-filled` — bentuk pejal membulat yang terbaca
 * sebagai objek padat, bukan gambar garis, senada dengan dunia serba-render kit ini).
...
export const HYPERREALITY_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item tk-dropdown-item-danger">${icon('delete', 15)} Hapus</button>
    </div>
</div>
`,
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('board', 17)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('data-trending', 17)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn tk-action-btn-danger" aria-label="Hapus">${icon('delete', 15)}</button>
            </td>
        </tr>
        <tr>
...
`,
    ...
    <span class="tk-empty-icon">${icon('mail-inbox', 26)}</span>
...
<section class="tk-cta">
    ...
    <button class="tk-btn tk-btn-secondary">Mulai Sekarang</button>
</section>
`
};
