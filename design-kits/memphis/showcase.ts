...
/**
 * `showcase.html` kit Memphis: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const MEMPHIS_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Memphis — Design Kit Showcase</title>
...
<body>
${exNav('Memphis', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Memphis</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Bentuk geometris playful, pola dots, squiggle, dan warna cerah pink-teal-kuning &mdash; fun dan sengaja tidak terlalu formal. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Fredoka (heading membulat &amp; fun) &middot; Nunito (body ramah) &middot; Space Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Dots &amp; squiggle</span><span class="tk-badge">Pink-teal-kuning</span><span class="tk-badge">Bentuk playful</span><span class="tk-badge">Fun, tidak formal</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Warisan Memphis Group era 80-an: desain yang menolak serius. Kanvas krem bertabur polka dots halus, headline digarisbawahi squiggle pink, ikon fitur bergiliran lingkaran pink, persegi teal miring, dan belah ketupat kuning. Kartu bergaris tinta dengan bayangan offset warna-warni, tombol pil gemuk, dan tipografi Fredoka yang membulat &mdash; semuanya sengaja fun.</p>`)}
