...
/**
 * Halaman contoh (`examples/`) kit Memphis: admin dashboard dan landing page utuh yang
...
<title>Memphis — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Memphis', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Memphis', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<head>
${HEAD_COMMON}
<title>Memphis — Contoh ${title}</title>
<style>
    ${EX_NAV_CSS}
${AUTH_CSS}
</style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Memphis', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<head>
${HEAD_COMMON}
<title>Memphis — ${title} (Ponsel)</title>
<style>
    ${EX_NAV_CSS}
...
<body>
${exNav('Memphis', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const MEMPHIS_EXAMPLES: Record<string, string> = {
