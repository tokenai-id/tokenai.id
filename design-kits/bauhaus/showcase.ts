...
/**
 * `showcase.html` kit Bauhaus: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const BAUHAUS_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Bauhaus — Design Kit Showcase</title>
...
<body>
${exNav('Bauhaus', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Bauhaus</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Bentuk geometris dasar &mdash; lingkaran, persegi, belah ketupat &mdash; tipografi geometris tegas, dan trio merah-kuning-biru di atas kertas krem: artistik tetapi tetap fungsional. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Jost (heading geometris ala Futura) &middot; DM Sans (body) &middot; DM Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Geometri dasar</span><span class="tk-badge">Merah-kuning-biru</span><span class="tk-badge">Kertas krem</span><span class="tk-badge">Fungsional</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Warisan sekolah Bauhaus: form follows function. Kertas krem hangat dengan garis tinta tegas, sudut siku, dan komposisi yang lahir dari bentuk geometris dasar &mdash; ikon fitur bergiliran menjadi lingkaran merah, persegi biru, dan belah ketupat kuning; bilah tiga warna menandai headline. Tipografi geometris Jost memikul hierarki, caption DM Mono uppercase menjaga keteraturan.</p>`)}
