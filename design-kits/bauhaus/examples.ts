...
/**
 * Halaman contoh (`examples/`) kit Bauhaus: admin dashboard dan landing page utuh yang
...
<link href="https://fonts.googleapis.com/css2?family=Jost:wght@500;600;700&family=DM+Sans:wght@400;500;700&family=DM+Mono:wght@400;500&display=swap" rel="stylesheet">
...
<title>Bauhaus — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Bauhaus', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Bauhaus', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<head>
${HEAD_COMMON}
<title>Bauhaus — Contoh ${title}</title>
<style>
    ${EX_NAV_CSS}
${AUTH_CSS}
</style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Bauhaus', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<head>
${HEAD_COMMON}
<title>Bauhaus — ${title} (Ponsel)</title>
<style>
    ${EX_NAV_CSS}
...
<body>
${exNav('Bauhaus', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const BAUHAUS_EXAMPLES: Record<string, string> = {
