...
/**
 * `showcase.html` kit Maximal: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const MAXIMAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Maximal — Design Kit Showcase</title>
...
<body>
${exNav('Maximal', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Maximal</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Lebih itu lebih: warna berani saling bertabrakan, tipografi raksasa, pola dan tekstur bertumpuk, gradasi dan bayangan berlapis &mdash; tersedia mode terang (permen) dan gelap (neon). Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Unbounded (heading, ekspresif &amp; lebar) &middot; Sora (body) &middot; Space Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Lebih itu lebih</span><span class="tk-badge">Warna tabrakan</span><span class="tk-badge">Pola &amp; tekstur</span><span class="tk-badge">Gradasi neon</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Kebalikan minimalism: magenta, ungu elektrik, kuning asam, dan toska dipakai sekaligus &mdash; saling bertabrakan dengan sengaja. Latar bertabur pola titik dan garis, kartu berwarna bergantian dengan bayangan dua lapis, judul Unbounded raksasa bergradasi, dan setiap elemen aktif disorot stabilo. Ramai, tetapi tetap tertata di atas grid yang disiplin.</p>`)}
