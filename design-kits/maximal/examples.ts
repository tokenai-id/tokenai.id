...
/**
 * Halaman contoh (`examples/`) kit Maximal: admin dashboard dan landing page utuh yang
...
<link href="https://fonts.googleapis.com/css2?family=Unbounded:wght@500;700;900&family=Sora:wght@400;600;700&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">
...
<title>Maximal — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Maximal', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Maximal', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<head>
${HEAD_COMMON}
<title>Maximal — Contoh ${title}</title>
<style>
    ${EX_NAV_CSS}
${AUTH_CSS}
</style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Maximal', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<head>
${HEAD_COMMON}
<title>Maximal — ${title} (Ponsel)</title>
<style>
    ${EX_NAV_CSS}
...
<body>
${exNav('Maximal', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const MAXIMAL_EXAMPLES: Record<string, string> = {
