...
import { BENTO_COMPONENTS } from './components';
...
/**
 * `showcase.html` kit Bento: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const BENTO_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Bento — Design Kit Showcase</title>
...
<body>
${exNav('Bento', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Bento</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Halaman dibagi menjadi kotak-kotak modular seperti bento box &mdash; kartu membulat besar di atas latar lembut, border halus, bayangan ambient tipis, dan grid asimetris; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Manrope (heading) &middot; Figtree (body) &middot; Geist Mono (caption &amp; kode) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Modular</span><span class="tk-badge">Kotak bento</span><span class="tk-badge">Radius besar</span><span class="tk-badge">Grid asimetris</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Setiap jenis informasi mendapat kotaknya sendiri: kartu membulat besar tersusun rapat di atas latar abu lembut, dipisah border halus dan bayangan ambient tipis &mdash; seperti bento box yang tiap sekatnya berisi lauk berbeda. Grid fitur asimetris dengan tile sorotan berwarna pastel, aksen indigo dipakai hemat, tipografi Manrope yang bersih dan tegas.</p>`)}
