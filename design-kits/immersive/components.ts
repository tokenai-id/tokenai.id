...
/**
 * Fragmen `components/` kit Immersive: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set ion — Ionicons yang solid dan tegas, terbaca jelas di adegan gelap).
...
export const IMMERSIVE_COMPONENTS: Record<string, string> = {
...
`,
    ...
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('pencil', 15)} Edit</button>
...
`,
    ...
    <button class="tk-btn tk-btn-outline">${icon('funnel', 15)} Filter <span class="tk-filter-count">2</span></button>
</div>
...
<nav class="tk-breadcrumb">
    <a href="#">Beranda</a>
    <span class="tk-breadcrumb-sep">${icon('chevron-forward', 12)}</span>
    <a href="#">Proyek</a>
    <span class="tk-breadcrumb-sep">${icon('chevron-forward', 12)}</span>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('speedometer', 17)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('stats-chart', 17)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('pencil', 15)}</button>
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('ellipsis-horizontal', 15)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('file-tray', 26)}</span>
