...
/**
 * Fragmen `components/` kit Retro Web: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set pixelarticons — ikon pixel yang senada dengan bitmap font kit).
...
export const RETRO_WEB_COMPONENTS: Record<string, string> = {
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('monitor', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('chart-bar-big', 18)} <span class="tk-sidebar-label">Laporan</span></a>
    <span class="tk-sidebar-group">Lainnya</span>
    <a class="tk-sidebar-item" href="#">${icon('settings-cog', 18)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('more-horizontal', 16)}</button>
