...
/**
 * `showcase.html` kit Bold Minimal: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
const c = BOLD_MINIMAL_COMPONENTS;
...
export const BOLD_MINIMAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Bold Minimal — Design Kit Showcase</title>
...
<body>
${exNav('Bold Minimal', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Bold Minimal</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Struktur tetap minimal &mdash; tetapi headline-nya raksasa dan satu biru elektrik mendominasi tanpa kompromi. Kontras sangat tinggi, sisanya putih lapang. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Archivo (heading weight 900 raksasa &amp; body &mdash; satu keluarga) &middot; Space Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Headline raksasa</span><span class="tk-badge">Satu biru elektrik</span><span class="tk-badge">Kontras tinggi</span><span class="tk-badge">Putih lapang</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Minimalism yang berani bersuara: strukturnya tetap hening &mdash; putih lapang, hairline, sedikit elemen &mdash; tetapi satu-dua elemen dibiarkan sangat dominan. Headline Archivo weight 900 berukuran raksasa dengan tracking rapat, dan satu biru elektrik menjadi satu-satunya warna: tombol utama, tautan, sorotan, dan CTA. Hitam pekat di atas putih untuk kontras maksimal.</p>`)}
