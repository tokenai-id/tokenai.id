...
/**
 * Fragmen `components/` kit Clay: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set uil / Unicons — garis bulat ramah yang senada dengan bentuk
 * clay). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen saat
...
export const CLAY_COMPONENTS: Record<string, string> = {
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('apps', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('setting', 18)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('bolt', 26)}</span>
