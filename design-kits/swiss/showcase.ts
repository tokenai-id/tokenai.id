...
/**
 * `showcase.html` kit Swiss: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const SWISS_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Swiss — Design Kit Showcase</title>
...
<body>
${exNav('Swiss', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Swiss</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Grid sangat disiplin, sans-serif grotesque, rata kiri yang tegas, whitespace luas, dan satu merah Swiss sebagai aksen &mdash; hierarki informasi yang tidak mungkin salah baca. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Hanken Grotesk (heading &amp; body &mdash; grotesque ala Helvetica) &middot; Fragment Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Grid disiplin</span><span class="tk-badge">Merah Swiss</span><span class="tk-badge">Rata kiri tegas</span><span class="tk-badge">Whitespace luas</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">International Typographic Style: grid yang sangat disiplin, sudut siku tanpa radius, nyaris tanpa bayangan &mdash; keteraturan lahir dari garis hairline dan penjajaran yang kuat. Tipografi grotesque rata kiri memikul seluruh hierarki: judul Hanken Grotesk tebal dengan tracking rapat, caption Fragment Mono uppercase berjarak renggang. Satu merah Swiss dipakai presisi untuk aksi utama dan penanda &mdash; sisanya hitam di atas putih.</p>`)}
