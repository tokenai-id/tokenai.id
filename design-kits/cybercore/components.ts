...
/**
 * Fragmen `components/` kit Cybercore: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set codicon — ikon antarmuka VS Code, senada dengan aesthetic
 * antarmuka komputer). Gayanya seluruhnya di `styles.css` — fragmen inilah yang disalin agen
 * saat merakit halaman, jadi jangan menaruh style atribut di sini.
 *
...
export const CYBERCORE_COMPONENTS: Record<string, string> = {
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item" href="#">${icon('graph', 18)} <span class="tk-sidebar-label">Laporan</span></a>
    <span class="tk-sidebar-group">Lainnya</span>
    <a class="tk-sidebar-item" href="#">${icon('settings-gear', 18)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
...
`,
    ...
    <h1 class="tk-display tk-cursor">Bangun lebih cepat</h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('pulse')}</span>
