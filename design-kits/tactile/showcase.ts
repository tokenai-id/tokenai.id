...
import { TACTILE_COMPONENTS } from './components';
...
/**
 * `showcase.html` kit Tactile: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const TACTILE_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Tactile — Design Kit Showcase</title>
...
<body>
${exNav('Tactile', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Tactile</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Brutalism yang naik kelas &mdash; tekstur kertas bernoise, kedalaman berlapis, dan elemen yang terasa punya material fisik: kartu seperti karton terangkat dari halaman, palet hangat terracotta; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Fraunces (heading, serif) &middot; Work Sans (body) &middot; Chivo Mono (caption &amp; tombol) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Tekstur</span><span class="tk-badge">Depth berlapis</span><span class="tk-badge">Material fisik</span><span class="tk-badge">Hangat</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Brutalism yang tumbuh dewasa: garis tinta tebal dan bayangan offset tetap ada, tetapi kini berlapis bayangan lembut sehingga kartu terasa seperti karton yang benar-benar terangkat dari kertas bertekstur. Palet hangat &mdash; krem, tinta cokelat, terracotta &mdash; dengan judul serif Fraunces yang terasa dicetak, caption dan tombol bermono seperti label mesin tik.</p>`)}
