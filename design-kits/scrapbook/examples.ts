...
/**
 * Halaman contoh (`examples/`) kit Scrapbook: admin dashboard dan landing page utuh yang
...
<link href="https://fonts.googleapis.com/css2?family=Kalam:wght@400;700&family=Nunito:wght@400;600;700;800&family=Cutive+Mono&display=swap" rel="stylesheet">
...
<title>Scrapbook — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Scrapbook', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Scrapbook', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<head>
${HEAD_COMMON}
<title>Scrapbook — Contoh ${title}</title>
<style>
    ${EX_NAV_CSS}
${AUTH_CSS}
</style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Scrapbook', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<head>
${HEAD_COMMON}
<title>Scrapbook — ${title} (Ponsel)</title>
<style>
    ${EX_NAV_CSS}
...
<body>
${exNav('Scrapbook', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const SCRAPBOOK_EXAMPLES: Record<string, string> = {
