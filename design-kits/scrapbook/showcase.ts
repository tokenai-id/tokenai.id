...
/**
 * `showcase.html` kit Scrapbook: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const SCRAPBOOK_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Scrapbook — Design Kit Showcase</title>
...
<body>
${exNav('Scrapbook', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Scrapbook</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Buku tempel yang terasa handmade &mdash; washi tape belang, stiker, sobekan kertas, tulisan tangan, perangko, dan potongan kertas yang digunting tangan; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Kalam (heading, tulisan tangan) &middot; Nunito (body) &middot; Cutive Mono (caption &amp; tombol, mesin tik) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Washi tape</span><span class="tk-badge">Torn paper</span><span class="tk-badge">Perangko</span><span class="tk-badge">Handmade</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Lebih handmade daripada kolase: heading benar-benar ditulis tangan (Kalam), tombol dan kartu digunting dengan sudut yang tidak rata, judul hero berupa sobekan kertas bergerigi, washi tape belang menandai yang aktif, badge seperti perangko berlubang, dan caption diketik mesin tik. Kertas kraft hangat bergaris buku tulis, dengan mawar dan hijau daun sebagai aksen.</p>`)}
