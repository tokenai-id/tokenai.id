...
/**
 * Fragmen `components/` kit Cyberpunk: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set ph / Phosphor — geometris bersih yang senada dengan HUD futuristik).
...
export const CYBERPUNK_COMPONENTS: Record<string, string> = {
...
<div class="tk-field">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih satu opsi</span> ${icon('caret-down', 16)}</button>
...
`,
    ...
    <span class="tk-search-icon">${icon('magnifying-glass', 16)}</span>
...
`,
    ...
    <button class="tk-select-trigger" type="button">Opsi pertama ${icon('caret-down', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih anggota</span> ${icon('caret-down', 16)}</button>
    <div class="tk-select-menu">
        <div class="tk-select-menu-search">${icon('magnifying-glass', 14)}<input type="text" placeholder="Cari anggota..."></div>
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button">Peran &middot; 2 dipilih ${icon('caret-down', 16)}</button>
    <div class="tk-select-menu">
...
`,
    ...
    <button class="tk-btn tk-btn-outline">Aksi ${icon('caret-down', 16)}</button>
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('pencil-simple', 16)} Edit</button>
...
`,
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua status ${icon('caret-down', 16)}</button>
        <div class="tk-select-menu">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua peran ${icon('caret-down', 16)}</button>
        <div class="tk-select-menu">
            <label class="tk-option"><input class="tk-checkbox" type="checkbox" checked> Designer</label>
            <label class="tk-option"><input class="tk-checkbox" type="checkbox"> Developer</label>
        </div>
    </div>
    <button class="tk-btn tk-btn-outline">${icon('funnel', 16)} Filter <span class="tk-filter-count">2</span></button>
</div>
...
<nav class="tk-breadcrumb">
    <a href="#">Beranda</a>
    <span class="tk-breadcrumb-sep">${icon('caret-right', 14)}</span>
    <a href="#">Proyek</a>
    <span class="tk-breadcrumb-sep">${icon('caret-right', 14)}</span>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('squares-four', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('gear', 18)} <span class="tk-sidebar-label">Pengaturan</span></a>
</aside>
`,
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('pencil-simple', 16)}</button>
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('dots-three', 16)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('tray', 28)}</span>
...
`,
    ...
    <h1 class="tk-display tk-glitch">Bangun lebih cepat</h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('lightning')}</span>
