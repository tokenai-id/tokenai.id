...
/**
 * Fragmen `components/` kit Acid Graphics: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set iconoir — garis tipis tajam yang kontras dengan blob fluoro).
...
export const ACID_GRAPHICS_COMPONENTS: Record<string, string> = {
...
<div class="tk-field">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih satu opsi</span> ${icon('nav-arrow-down', 16)}</button>
...
`,
    ...
    <button class="tk-select-trigger" type="button">Opsi pertama ${icon('nav-arrow-down', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button"><span class="tk-select-placeholder">Pilih anggota</span> ${icon('nav-arrow-down', 16)}</button>
    <div class="tk-select-menu">
...
<div class="tk-select">
    <button class="tk-select-trigger" type="button">Peran &middot; 2 dipilih ${icon('nav-arrow-down', 16)}</button>
    <div class="tk-select-menu">
...
`,
    ...
    <button class="tk-btn tk-btn-outline">Aksi ${icon('nav-arrow-down', 16)}</button>
    <div class="tk-dropdown-menu">
        ...
        <button class="tk-dropdown-item">${icon('edit-pencil', 16)} Edit</button>
...
`,
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua status ${icon('nav-arrow-down', 16)}</button>
        <div class="tk-select-menu">
    ...
    <div class="tk-select">
        <button class="tk-select-trigger" type="button">Semua peran ${icon('nav-arrow-down', 16)}</button>
        <div class="tk-select-menu">
            <label class="tk-option"><input class="tk-checkbox" type="checkbox" checked> Designer</label>
...
<nav class="tk-breadcrumb">
    <a href="#">Beranda</a>
    <span class="tk-breadcrumb-sep">${icon('nav-arrow-right', 14)}</span>
    <a href="#">Proyek</a>
    <span class="tk-breadcrumb-sep">${icon('nav-arrow-right', 14)}</span>
...
<aside class="tk-sidebar">
    ...
    <a class="tk-sidebar-item tk-sidebar-item-active" href="#">${icon('view-grid', 18)} <span class="tk-sidebar-label">Dashboard</span></a>
    ...
    <a class="tk-sidebar-item" href="#">${icon('stats-report', 18)} <span class="tk-sidebar-label">Laporan</span></a>
    ...
    <tbody>
        <tr>
            ...
            <td class="tk-table-actions">
                ...
                <button class="tk-action-btn" aria-label="Edit">${icon('edit-pencil', 16)}</button>
        ...
        <tr>
            ...
            <td class="tk-table-actions">
                <div class="tk-dropdown">
                    <button class="tk-action-btn" aria-label="Menu aksi">${icon('more-horiz', 16)}</button>
...
`,
    ...
    <span class="tk-empty-icon">${icon('flower', 28)}</span>
...
`,
    ...
    <h1 class="tk-display"><span class="tk-warp tk-acid-text">Bangun lebih cepat</span></h1>
...
<div class="tk-feature-grid">
    <div class="tk-feature">
        <span class="tk-feature-icon">${icon('flash')}</span>
