...
import { CHARTJS_SCRIPT, CHART_HELPER_SCRIPT, EX_NAV_CSS, exNav } from './preview-scaffold';

/**
 * `showcase.html` kit Neutral Modern: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
const c = NEUTRAL_MODERN_COMPONENTS;
...
const SWATCHES = [
    ['primary', '#18181B'], ['primary-hover', '#3F3F46'], ['secondary', '#F4F4F5'],
    ['accent', '#2563EB'], ['background', '#FFFFFF'], ['surface-2', '#F4F4F5'],
    ['text', '#09090B'], ['text-muted', '#71717A'], ['border', '#E4E4E7'],
...
const TYPE_SCALE = [
    ['Display', 'tk-display', '60px'], ['Heading 1', 'tk-h1', '48px'], ['Heading 2', 'tk-h2', '32px'],
    ['Heading 3', 'tk-h3', '24px'], ['Heading 4', 'tk-h4', '20px'], ['Title', 'tk-title', '18px'],
...
export const NEUTRAL_MODERN_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Neutral Modern — Design Kit Showcase</title>
...
<body>
${exNav('Neutral Modern', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Neutral Modern</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Bersih, netral, profesional, kontras lembut &mdash; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Inter &middot; heading 600 &middot; body 400 &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Bersih</span><span class="tk-badge">Netral</span><span class="tk-badge">Profesional</span><span class="tk-badge">Kontras lembut</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Permukaan putih dengan garis batas tipis, satu warna aksen yang dipakai hemat, dan kedalaman dari bayangan halus. Kepribadiannya datang dari tipografi dan ruang, bukan dari warna.</p>`)}
