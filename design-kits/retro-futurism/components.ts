...
/**
 * Fragmen `components/` kit Retrofuturism: markup murni dengan kelas kontrak, teks placeholder
 * netral, ikon Iconify (set tabler — garis geometris tipis yang senada dengan panel instrumen).
...
export const RETRO_FUTURISM_COMPONENTS: Record<string, string> = {
