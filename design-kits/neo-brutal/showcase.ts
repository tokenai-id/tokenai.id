...
/**
 * `showcase.html` kit Neo Brutal: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const NEO_BRUTAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Neo Brutal — Design Kit Showcase</title>
...
<body>
${exNav('Neo Brutal', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Neo Brutal</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Brutalism yang modern dan usable &mdash; latar krem, warna cerah playful, border hitam tebal, bayangan offset keras, kartu sederhana bersudut lembut, dan tipografi bold; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Bricolage Grotesque (heading, bold) &middot; DM Sans (body) &middot; DM Mono (kode &amp; caption) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Warna cerah</span><span class="tk-badge">Border tebal</span><span class="tk-badge">Shadow keras</span><span class="tk-badge">Bold &amp; usable</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Brutalism yang dijinakkan tanpa kehilangan gigitannya: setiap elemen berdiri di atas latar krem dengan border hitam tegas dan bayangan offset pekat, tetapi sudutnya dilembutkan dan warnanya cerah playful &mdash; pink, kuning stabilo, biru elektrik. Tipografi Bricolage Grotesque yang gemuk memimpin, komponennya tetap rapi dan nyaman dipakai sehari-hari.</p>`)}
