...
/**
 * `showcase.html` kit Collage: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const COLLAGE_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Collage — Design Kit Showcase</title>
...
<body>
${exNav('Collage', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Collage</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Banyak elemen ditumpuk dalam satu komposisi seperti scrapbook &mdash; stiker cut-out bertepi putih, selotip, rotasi ringan, anotasi tulisan tangan, dan tekstur halftone; tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">DM Serif Display (heading) &middot; Karla (body) &middot; Caveat (anotasi tangan) &middot; Fira Mono (caption &amp; tombol) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Cut-out</span><span class="tk-badge">Selotip</span><span class="tk-badge">Tulisan tangan</span><span class="tk-badge">Halftone</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Setiap elemen terasa ditempel ke halaman: kartu bergaya stiker cut-out dengan tepi putih tebal, tile fitur miring ringan dengan strip selotip yang menegak saat disentuh, judul serif seperti sobekan kertas yang dipaste, dan anotasi tulisan tangan Caveat. Merah poster dan biru klein di atas kertas krem bertekstur titik halftone &mdash; seperti spread scrapbook yang hidup.</p>`)}
