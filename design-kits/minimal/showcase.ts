...
/**
 * `showcase.html` kit Minimal: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const MINIMAL_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Minimal — Design Kit Showcase</title>
...
<body>
${exNav('Minimal', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Minimal</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Sangat bersih dan lapang: sedikit elemen, banyak whitespace, palet monokrom dengan garis hairline &mdash; konten dan hierarki yang bicara. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Inter (heading &amp; body &mdash; satu keluarga, hierarki dari ukuran &amp; bobot) &middot; IBM Plex Mono (caption &amp; label) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Whitespace lapang</span><span class="tk-badge">Monokrom</span><span class="tk-badge">Hairline</span><span class="tk-badge">Fokus konten</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Putih lapang dengan sedikit elemen: palet dibatasi hitam, putih, dan abu; garis pemisah hairline 1px; bayangan nyaris tak terlihat. Hierarki lahir dari ukuran dan bobot Inter, bukan dari dekorasi &mdash; kontennyalah yang jadi pusat perhatian. Satu-satunya warna kuat adalah hitam tombol utama.</p>`)}
