...
/**
 * Halaman contoh (`examples/`) kit Y2K: admin dashboard dan landing page utuh yang
...
<link href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@500;600;700;800&family=Exo+2:wght@400;500;600;700&family=VT323&display=swap" rel="stylesheet">
...
<title>Y2K — Contoh Admin Dashboard</title>
<style>
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Y2K', 'dashboard', '../', { device: { base: 'dashboard', active: 'web' } })}
<div class="dm-shell">
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Y2K', 'landing', '../', { device: { base: 'landing', active: 'web' } })}
...
<body>
${EX_EMBED_SCRIPT}
${exNav('Y2K', 'components', '../', { device: { base, active: 'web' } })}
<div class="au-wrap">
...
<body>
${exNav('Y2K', view, '../', { device: { base, active: 'mobile' }, extraThemeJs: FRAME_THEME_EXTRA_JS })}
<div class="ex-stage">
...
export const Y2K_EXAMPLES: Record<string, string> = {
