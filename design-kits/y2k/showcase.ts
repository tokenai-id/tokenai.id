...
/**
 * `showcase.html` kit Y2K: lembar peraga 22 seksi sesuai §6 kontrak — termasuk
...
export const Y2K_SHOWCASE = `<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Y2K — Design Kit Showcase</title>
...
<body>
${exNav('Y2K', 'components', '')}
<div class="sc-wrap">
    <p class="sc-kit-title">TOKENAI Design Kit</p>
    <h1 class="tk-h1" style="margin: 0">Y2K</h1>
    <p class="tk-body-lg tk-muted" style="margin-top: 8px">Nostalgia internet awal 2000-an: chrome metalik, UI glossy, bubble text, gradient iridescent biru-ungu-pink, dan label pixel &mdash; nuansa cyber-pop. Tersedia mode terang dan gelap. Lihat juga contoh halaman nyata lewat bilah navigasi di atas.</p>

${section('Typography', `<p class="tk-caption" style="margin-bottom: 24px">Baloo 2 (heading bubble membulat) &middot; Exo 2 (body techy) &middot; VT323 (caption &amp; label pixel) &middot; skala di bawah adalah seluruh tingkat yang tersedia</p>${TYPE_SCALE}`)}
...
${section('Design Language', `<div class="sc-row"><span class="tk-badge">Chrome &amp; metallic</span><span class="tk-badge">Glossy UI</span><span class="tk-badge">Iridescent</span><span class="tk-badge">Cyber-pop</span></div><p class="tk-body-sm tk-muted" style="margin-top: 16px; max-width: 560px">Nostalgia era dial-up dan CD sampul hologram: navbar berlapis chrome metalik, tombol pil glossy dengan kilau kaca di paruh atasnya, headline bubble bergradasi iridescent biru-ungu-pink, dan ikon fitur seperti tombol aqua yang mengilap. Label dan caption memakai VT323 pixel &mdash; sentuhan grafis 8-bit di antara permukaan yang serba licin.</p>`)}
